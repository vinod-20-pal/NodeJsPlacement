...
/**
 * Purpose : Render allocate interview page
 * @param {*} req 
 * @param {*} res 
 * @returns 
 */
...
/**
 * Purpose: Schedule interview in database entry
 * @param {*} req 
 * @param {*} res 
 * @returns 
 */
...
/**
 * Purpose: Update database entry of update status.
 * @param {*} req 
 * @param {*} res 
 * @returns 
 */
